    ...
    <form action="form-handlers/seller-form-handler.php" method="POST" class="form-wrapper">
        ...
        <div class="input-wrapper">
            ...
            <input class="input" type="text" name="firstname" id="firstname" placeholder="Ditt förnamn">
        </div>
        <div class="input-wrapper">
            <label for="lastname" class="input-label">Efternamn<pre>*</pre></label>
            <input class="input" type="text" name="lastname" id="lastname" placeholder="Ditt efternamn">
        </div>
        <div class="input-wrapper">
            <label for="email" class="input-label">Email-adress<pre>*</pre></label>
            <input class="input" type="text" name="email" id="email" placeholder="Din e-postadress">
        </div> 
